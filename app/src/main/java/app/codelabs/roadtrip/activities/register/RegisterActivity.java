package app.codelabs.roadtrip.activities.register;
...
public class RegisterActivity extends AppCompatActivity {
    private EditText etPhone, etName, etEmail, etPassword, etConPass;
    ...
    private void setEvent() {
        ...
        btnRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                data.put("confirm_password", etConPass.getText().toString());
