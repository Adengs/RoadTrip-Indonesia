...
public interface ApiService {
    ...
    Call<ResponseFinishPassword> finishpassword(@Body Map<String, String> body, @Header("app-token") String apptoken);

    @GET("api/article/detail?article_id=1")
    Call<ResponseArticleDetail> articledetail(@Header ("Authorization")String token , @Header("app-token") String AppToken);
